...
export const dictionaries = {
  en: {
    ...
    footer: {
      summary:
        "ARK Legacy Partner provides financial planning and insurance solution discussions for personal and business needs in Malaysia.",
      contact: "Email",
      email: "arklegacypartner@gmail.com",
      whatsappLabel: "WhatsApp",
      whatsapp: "016-888 0436",
      whatsappUrl: "https://wa.me/60168880436",
      phoneLabel: "Phone",
      phone: "012-630 1432",
      phoneHref: "tel:+60126301432",
      addressLabel: "Office",
      address: [
        "1-3, 2 RIO Office Park, OP 3F-01,",
        "Persiaran Rio,",
        "Bandar Puteri,",
        "47100 Puchong,",
        "Selangor, Malaysia.",
    ...
    contactPage: {
      ...
      intro: {
        ...
        copy:
          "Email ARK Legacy Partner to share the area you would like to discuss. Additional contact channels will be added only after verification.",
      },
      process: [
      ...
      form: {
        title: "Email ARK",
        copy:
          "A direct email is the current verified contact method while the website enquiry workflow is being prepared.",
        email: "arklegacypartner@gmail.com",
        cta: "Email ARK",
        whatsappCta: "Chat on WhatsApp",
        whatsappUrl: "https://wa.me/60168880436",
        consentBefore: "Before sharing personal information, please review the ",
      ...
      direct: {
        ...
        copy:
          "For verified contact, please email ARK Legacy Partner directly or refer to the office address below.",
        emailLabel: "Email",
        email: "arklegacypartner@gmail.com",
        whatsappLabel: "WhatsApp",
        whatsapp: "016-888 0436",
  ...
  zh: {
    ...
    footer: {
      summary:
        "ARK Legacy Partner 为马来西亚个人与企业客户提供财务规划与保险方案相关讨论。",
      contact: "电邮",
      email: "arklegacypartner@gmail.com",
      whatsappLabel: "WhatsApp",
      whatsapp: "016-888 0436",
      ...
      legal: "法律",
      disclaimer:
        "免责声明：本网站内容仅供一般教育参考，不构成财务、法律、税务或投资建议。ARK Legacy Partner / 顾问为 AIA 委任保险代理。正式上线前需完成法律与合规审核。执照编号与代理编号只会在完成核实与批准后显示。",
      rights: "版权所有。",
    ...
    contactPage: {
      ...
      intro: {
        ...
        title: "先从一次清晰对话开始。",
        copy:
          "你可以通过电邮分享想了解的方向。其他联系渠道只会在完成核实后显示。",
      },
      process: [
      ...
      form: {
        title: "电邮联系 ARK",
        copy:
          "在网站正式提交流程完成前，电邮是目前已核实的联系方式。",
        email: "arklegacypartner@gmail.com",
        cta: "电邮联系 ARK",
        whatsappCta: "WhatsApp 联系我们",
        whatsappUrl: "https://wa.me/60168880436",
        consentBefore: "在分享个人资料前，请先阅读",
        privacyPolicy: "隐私政策",
        consentAfter: "约束。",
      },
      direct: {
        eyebrow: "直接联系",
        title: "希望直接与我们联系？",
        copy: "如需联系 ARK Legacy Partner，请使用以下已核实电邮，或参考下方办公室地址。",
        emailLabel: "电子邮箱",
        email: "arklegacypartner@gmail.com",
        whatsappLabel: "WhatsApp",
        whatsapp: "016-888 0436",
